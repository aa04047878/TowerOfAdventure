...
public class WaterLevel1Ani : MonoBehaviour, ILevelAni
{
    ...
    public void EnemyDead(int nowBattle, int atkOrderUI)
    {
        ...
        //-------------
        if (WaterLevel1Manager.inst.IntoNextBattle())
        {
            //可以進入下一個關卡代表最後一隻怪物死了，
            //開始檢查最後一隻死亡的動畫完成了沒。
            WaterLevel1Manager.inst.ballCtrl.turnBeadsStatus = TurnBeadsStatus.IntoNextBattle;
    ...
    {
        WaterLevel1Manager.inst.ballCtrl.turnBeadsStatus = TurnBeadsStatus.PlayerDead;
    ...
    {
        WaterLevel1Manager.inst.CanTurnBeats();
    }
    ...
    {
        WaterLevel1Manager.inst.ballCtrl.turnBeadsStatus = TurnBeadsStatus.WaitGenerate;
    ...
    void Start()
    {
        ...
        WaterLevel1Manager.inst.SetLevelAni(this);
    }
