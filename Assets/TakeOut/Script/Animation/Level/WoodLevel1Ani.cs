...
public class WoodLevel1Ani : MonoBehaviour, ILevelAni
{
    ...
    public void EnemyDead(int nowBattle, int atkOrderUI)
    {
        ...
        //-------------
        if (WoodLevel1Manager.inst.IntoNextBattle())
        {
            //可以進入下一個關卡代表最後一隻怪物死了，
            //開始檢查最後一隻死亡的動畫完成了沒。
            WoodLevel1Manager.inst.ballCtrl.turnBeadsStatus = TurnBeadsStatus.IntoNextBattle;
    ...
    {
        WoodLevel1Manager.inst.ballCtrl.turnBeadsStatus = TurnBeadsStatus.PlayerDead;
    ...
    public void IntoNextBattle()
    {
        if (intoNextBattle02)
        {
            ...
            WoodLevel1Manager.inst.BattleAdd();
            //PlayBattleAni();
    ...
    {
        WoodLevel1Manager.inst.CanTurnBeats();
    }
    ...
    {
        WoodLevel1Manager.inst.ballCtrl.turnBeadsStatus = TurnBeadsStatus.WaitGenerate;
        WoodLevel1Manager.inst.obj_CantTurnBeatsPanel.SetActive(true);
    }
    ...
    void Start()
    {
        ...
        WoodLevel1Manager.inst.SetLevelAni(this);
    }
