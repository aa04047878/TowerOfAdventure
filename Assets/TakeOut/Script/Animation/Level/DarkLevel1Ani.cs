...
public class DarkLevel1Ani : MonoBehaviour, ILevelAni
{
    ...
    public void EnemyDead(int nowBattle, int atkOrderUI)
    {
        ...
        //-------------
        if (DarkLevel1Manager.inst.IntoNextBattle())
        {
            //可以進入下一個關卡代表最後一隻怪物死了，
            //開始檢查最後一隻死亡的動畫完成了沒。
            DarkLevel1Manager.inst.ballCtrl.turnBeadsStatus = TurnBeadsStatus.IntoNextBattle;
    ...
    {
        DarkLevel1Manager.inst.ballCtrl.turnBeadsStatus = TurnBeadsStatus.PlayerDead;
    ...
    public void IntoNextBattle()
    {
        if (intoNextBattle02)
        {
            ...
            DarkLevel1Manager.inst.BattleAdd();
            //PlayBattleAni();
    ...
    {
        DarkLevel1Manager.inst.CanTurnBeats();
    }
    ...
    {
        DarkLevel1Manager.inst.ballCtrl.turnBeadsStatus = TurnBeadsStatus.WaitGenerate;
        DarkLevel1Manager.inst.obj_CantTurnBeatsPanel.SetActive(true);
    }
    ...
    void Start()
    {
        ...
        DarkLevel1Manager.inst.SetLevelAni(this);
    }
