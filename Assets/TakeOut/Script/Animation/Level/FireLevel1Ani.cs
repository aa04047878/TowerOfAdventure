...
public class FireLevel1Ani : MonoBehaviour, ILevelAni
{
    ...
    public void EnemyDead(int nowBattle, int atkOrderUI)
    {
        ...
        //-------------
        if (FireLevel1Manager.inst.IntoNextBattle())
        {
            //可以進入下一個關卡代表最後一隻怪物死了，
            //開始檢查最後一隻死亡的動畫完成了沒。
            FireLevel1Manager.inst.ballCtrl.turnBeadsStatus = TurnBeadsStatus.IntoNextBattle;
    ...
    {
        FireLevel1Manager.inst.ballCtrl.turnBeadsStatus = TurnBeadsStatus.PlayerDead;
    ...
    public void IntoNextBattle()
    {
        if (intoNextBattle02)
        {
            ...
            FireLevel1Manager.inst.BattleAdd();
            //PlayBattleAni();
    ...
    {
        FireLevel1Manager.inst.CanTurnBeats();
    }
    ...
    {
        FireLevel1Manager.inst.ballCtrl.turnBeadsStatus = TurnBeadsStatus.WaitGenerate;
        FireLevel1Manager.inst.obj_CantTurnBeatsPanel.SetActive(true);
    }
    ...
    void Start()
    {
        ...
        FireLevel1Manager.inst.SetLevelAni(this);
    }
