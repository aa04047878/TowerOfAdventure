...
public class DarkLevelInfoUI : IUserInterface
{
    private GameObject m_LevelInfoUI;
    private GameObject m_DarkLevelInfo;
    ...
    public DarkLevelInfoUI(TowerOfAdventureGame TOAGame) : base(TOAGame)
    {
        Initialize();
    }
    ...
    public override void Initialize()
    {
        ...
        m_DarkLevelInfo = m_LevelInfoUI.transform.GetChild(4).gameObject;
        BtnInit();
        DarkLevelInfoClose();
        BattleReadyTeamInit();
    }
    ...
    private void BtnInit()
    {
        ...
        mBtn_return = m_DarkLevelInfo.transform.GetChild(0).transform.GetChild(0).transform.GetChild(0).GetComponent<Button>();
        mBtn_return.onClick.AddListener(delegate ()
        {
            DarkLevelInfoClose();
        });
        //mBtn_Level1 = UITool.FindGameComponent<Button>("WaterLevel1");
        mBtn_Level1 = m_DarkLevelInfo.transform.GetChild(0).transform.GetChild(1).transform.GetChild(0).transform.GetChild(0).transform.GetChild(0).GetComponent<Button>();
        mBtn_Level1.onClick.AddListener(delegate () {
            BattleReadyTeamUIOpen();
            battleReadyTeamUIOpen = true;
        });
        m_BattleReadyTeamUI = m_DarkLevelInfo.transform.GetChild(1).gameObject;
    ...
    public void DarkLevelInfoOpen()
    {
        ...
        m_DarkLevelInfo.SetActive(true);
    }

    /// <summary>
    /// 暗關卡資訊關閉
    /// </summary>
    public void DarkLevelInfoClose()
    {
        m_BattleReadyTeamUI.SetActive(false);
        m_DarkLevelInfo.SetActive(false);
