...
public class LightLevelInfoUI : IUserInterface
{
    private GameObject m_LevelInfoUI;
    private GameObject m_LightLevelInfo;
    ...
    public LightLevelInfoUI(TowerOfAdventureGame TOAGame) : base(TOAGame)
    {
        Initialize();
    }
    ...
    public override void Initialize()
    {
        ...
        m_LightLevelInfo = m_LevelInfoUI.transform.GetChild(3).gameObject;
        BtnInit();
        LightLevelInfoClose();
        BattleReadyTeamInit();
    }
    ...
    private void BtnInit()
    {
        ...
        mBtn_return = m_LightLevelInfo.transform.GetChild(0).transform.GetChild(0).transform.GetChild(0).GetComponent<Button>();
        mBtn_return.onClick.AddListener(delegate ()
        {
            LightLevelInfoClose();
        });
        //mBtn_Level1 = UITool.FindGameComponent<Button>("WaterLevel1");
        mBtn_Level1 = m_LightLevelInfo.transform.GetChild(0).transform.GetChild(1).transform.GetChild(0).transform.GetChild(0).transform.GetChild(0).GetComponent<Button>();
        mBtn_Level1.onClick.AddListener(delegate () {
            BattleReadyTeamUIOpen();
            battleReadyTeamUIOpen = true;
        });
        m_BattleReadyTeamUI = m_LightLevelInfo.transform.GetChild(1).gameObject;
        ...
        mBtn_BattleReadySure.onClick.AddListener(delegate () {
            ...
            m_TOAGame.EnterLightLevel01Ani();
    ...
    public void LightLevelInfoOpen()
    {
        ...
        m_LightLevelInfo.SetActive(true);
    }

    /// <summary>
    /// 光關卡資訊關閉
    /// </summary>
    public void LightLevelInfoClose()
    {
        m_BattleReadyTeamUI.SetActive(false);
        m_LightLevelInfo.SetActive(false);
