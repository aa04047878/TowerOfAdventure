...
public class WoodLevelInfoUI : IUserInterface
{
    private GameObject m_LevelInfoUI;
    private GameObject m_WoodLevelInfo;
    ...
    public WoodLevelInfoUI(TowerOfAdventureGame TOAGame) : base(TOAGame)
    {
        Initialize();
    }
    ...
    public override void Initialize()
    {
        ...
        m_WoodLevelInfo = m_LevelInfoUI.transform.GetChild(2).gameObject;
        BtnInit();
        WoodLevelInfoClose();
        BattleReadyTeamInit();
    }
    ...
    private void BtnInit()
    {
        ...
        mBtn_return = m_WoodLevelInfo.transform.GetChild(0).transform.GetChild(0).transform.GetChild(0).GetComponent<Button>();
        mBtn_return.onClick.AddListener(delegate ()
        {
            WoodLevelInfoClose();
        });
        //mBtn_Level1 = UITool.FindGameComponent<Button>("WaterLevel1");
        mBtn_Level1 = m_WoodLevelInfo.transform.GetChild(0).transform.GetChild(1).transform.GetChild(0).transform.GetChild(0).transform.GetChild(0).GetComponent<Button>();
        mBtn_Level1.onClick.AddListener(delegate () {
            BattleReadyTeamUIOpen();
            battleReadyTeamUIOpen = true;
        });
        m_BattleReadyTeamUI = m_WoodLevelInfo.transform.GetChild(1).gameObject;
    ...
    public void WoodLevelInfoOpen()
    {
        ...
        m_WoodLevelInfo.SetActive(true);
    }

    /// <summary>
    /// 木關卡資訊關閉
    /// </summary>
    public void WoodLevelInfoClose()
    {
        m_BattleReadyTeamUI.SetActive(false);
        m_WoodLevelInfo.SetActive(false);
